...
Namespace StylingWithFillEmptySpace
	Partial Public Class XtraReport1
		...
		Private Sub XtraReport1_FillEmptySpace(ByVal sender As Object, ByVal e As BandEventArgs) Handles MyBase.FillEmptySpace
			...
			Dim targetSize As Size = New Size((Me.PageWidth - Me.Margins.Left - Me.Margins.Right), e.Band.Height)
			Dim labelSize As Size = New Size(Me.dummyDetailBandLabel.Width, Me.dummyDetailBandLabel.Height)
